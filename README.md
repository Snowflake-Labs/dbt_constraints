...
```
macro <ADAPTER_NAME>__create_primary_key(table_model, column_names, quote_columns=false)
macro <ADAPTER_NAME>__create_unique_key(table_model, column_names, quote_columns=false) 
macro <ADAPTER_NAME>__create_foreign_key(test_model, pk_model, pk_column_names, fk_model, fk_column_names, quote_columns=false) 
macro <ADAPTER_NAME>__unique_constraint_exists(table_relation, column_names) 
macro <ADAPTER_NAME>__foreign_key_exists(table_relation, column_names) 
```
